...
// 2. Agrega un servicio de correo (Gmail) y autoriza con contacto@palmisoft.com.co
    ...
    contactForm.addEventListener('submit', function(e) {
        ...
        if (isValid) {
            ...
            emailjs.send('service_acmkgtf', 'template_05etxzv', {
                ...
                to_email:   'contacto@palmisoft.com.co'
            }).then(function () {
...
console.log('%cContacto: contacto@palmisoft.com.co | +57 317 318 4631', 'color: #0ea5e9; font-size: 12px;');
